...
public class InscripcionResponseDTO {
    ...
    public InscripcionResponseDTO(Long idInscripcion, EstudianteClientDTO estudianteIdInscripcion, Long asignacionIdInscripcion, LocalDate fechaInscripcion, float totalPuntosInscripcion) {
    ...
    public EstudianteClientDTO getEstudianteIdInscripcion() {return estudianteIdInscripcion;}
    public void setEstudianteIdInscripcion(EstudianteClientDTO estudianteIdInscripcion) {this.estudianteIdInscripcion = estudianteIdInscripcion;}
